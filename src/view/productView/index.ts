...
export class ProductView {
  ...
  render(id: string) {
    ...
    fillBreadcrumbsNav({category, title}: Product) {
        this.breadcrumbsNav.innerHTML = `<ul class="breadcrumbs-nav__list">
                            <li class="breadcrumbs-nav__item"><a href="/main">Главная</a></li>
                            <li class="breadcrumbs-nav__item"><a href="#">${category.name}</a></li>
                            <li class="breadcrumbs-nav__item"><a href="#">${title}</a></li>
                        </ul>`;
    }
    ...
    addProduct(product: Product) {
        ...
        headStyleInner.innerHTML += `#rating-${product.id}:before {
                content: '★★★★★';
                letter-spacing: 3px;
                background: linear-gradient(90deg, #fc0 ${(product.rating / 5) * 100}%, #fff ${(product.rating / 5) * 100}%);
                -webkit-background-clip: text;
                -webkit-text-fill-color: transparent;}\n`;

        return `<div class="product__content">
                                ...
                                <div class="product__info">
                                    ...
                                    <ul class="product__info-list info-list">
                                        <li class="info-list__item">
                                            ...
                                            <span class="info-list__value">${product.category.name}</span>
                                        </li>
                                        <li class="info-list__item">
                                ...
                                <div class="product__price">
                                    ...
                                    <span class="product__price-discount">${(product.price - (product.price / 100) * product.discountPercentage).toFixed(2)}₽</span>
                                </div>

                                <div class="product__rating">
                                    <span class="product__rating-stars" id="rating-${product.id}">${product.rating}</span>
                                </div>
